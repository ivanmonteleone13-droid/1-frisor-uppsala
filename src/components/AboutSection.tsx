      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
          <div className="aspect-[4/5] overflow-hidden rounded-3xl shadow-xl">
            {aboutImage ? (
              <img src={aboutImage} alt={`${business.name} — barbershop på ${getFullAddress()}`} className="h-full w-full object-cover" loading="lazy" />
            ) : (
          ...
          <div>
            ...
            <div className="mt-6 rounded-2xl border border-[var(--primary)]/10 bg-[var(--accent)] px-6 py-4">
              ...
              <p className="text-sm text-[var(--primary)]/70">{business.reviewCount}+ omdömen på Bokadirekt</p>
              <p className="mt-2 text-sm text-[var(--primary)]/70">{getFullAddress()}</p>
            </div>
