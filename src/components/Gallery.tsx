...
function GalleryTile({ item }: { item: GalleryItem }) {
  ...
  const before = "before" in item ? item.before : "from-[#0f0f1a] to-[#1a1a2e]";
  const after = "after" in item ? item.after : "from-[#c9a227]/40 to-[#1a1a2e]";
    ...
    <section id="galleri" className="bg-[var(--dark)] py-20 text-white">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-2 text-3xl font-bold sm:text-4xl">Styling &amp; resultat</h2>
