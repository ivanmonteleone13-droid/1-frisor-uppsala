    ...
    >
      ...
      <div>
        ...
        <input
          ...
          name="name"
          required
          className="w-full rounded-xl border border-slate-200 px-4 py-3 text-sm outline-none ring-[#1a1a2e] focus:ring-2"
        />
      </div>
      <div>
        <label htmlFor="phone" className="mb-1 block text-sm font-medium text-[#1a1a2e]">
      ...
      <div>
        <label htmlFor="email" className="mb-1 block text-sm font-medium text-[#1a1a2e]">
          E-post <span className="font-normal text-[#1a1a2e]/50">(valfritt)</span>
        </label>
        <input
          id="email"
          name="email"
      ...
      <button
        type="submit"
        className="w-full rounded-full bg-[#1a1a2e] px-8 py-4 text-sm font-semibold text-white transition hover:bg-[#0f0f1a] sm:w-auto"
      >
        Skicka meddelande
      </button>
    </form>
